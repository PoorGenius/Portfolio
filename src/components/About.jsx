...
const Card = () => {
    return (
        <div className={`w-[220px] min-h-[315px] rounded-[15px] border-[3px] border-solid border-white/50 bg-[rgba(77,77,77,0.1)]
                        xl:w-[400px] xl:min-h-[570px]`}>
            <div className="flex flex-col gap-2 w-full items-center mt-6">
                <div className={`w-[150px] h-[110px] rounded-[15px] bg-[rgba(217,217,217,0.5)] flex justify-center items-center`}>
                ...
                <div>
                    <h1 className={`text-[18px] xl:text-[38px]`}>Discovery</h1>
                </div>

                <div className={`w-[160px] xl:w-[320px]`}>
                    <p className={`text-[10px] font-light leading-[125%] xl:text-[18px]`}>
